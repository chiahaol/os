...
/*
 * new a function called curr and append it to the end of list
 * its if_name is the exection place of this function
 * if_func is the total function needed space
 */
void init_call_all()
{
        list_t funcs;
