...
1)  Names and USC e-mail addresses of team members: Lung Chin <lungchin@usc.edu>, Chung-Han Lee <clee8175@usc.edu>, Chia-Hao Liu <chiahaol@usc.edu>, Jiun-Yih Yang <jiunyihy@usc.edu>
...
+--------------------------------------------------------------------------------------------+
sched_switch() currently uses busy waiting, so when using kshell, the self-check dbg call gets printed continuously. If this behavior is not desired, please comment out line 208 in proc/sched.c
